...
/* ./.libs/lt-csv2rec.c - temporary wrapper executable for .libs/csv2rec.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The csv2rec program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "csv2rec.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# csv2rec - temporary wrapper script for .libs/csv2rec.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The csv2rec program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"csv2rec.exe:csv2rec:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debi", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"csv2rec.exe:csv2rec:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"csv2rec.exe:csv2rec:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
