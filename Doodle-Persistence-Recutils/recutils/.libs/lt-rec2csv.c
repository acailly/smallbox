...
/* ./.libs/lt-rec2csv.c - temporary wrapper executable for .libs/rec2csv.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The rec2csv program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "rec2csv.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# rec2csv - temporary wrapper script for .libs/rec2csv.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The rec2csv program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"rec2csv.exe:rec2csv:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debi", f);
  fputs ("an-2.4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"rec2csv.exe:rec2csv:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"rec2csv.exe:rec2csv:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
