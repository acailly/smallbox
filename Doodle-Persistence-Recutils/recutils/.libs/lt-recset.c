...
/* ./.libs/lt-recset.c - temporary wrapper executable for .libs/recset.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The recset program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "recset.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# recset - temporary wrapper script for .libs/recset.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The recset program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"recset.exe:recset:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian", f);
  fputs ("-2.4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"recset.exe:recset:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"recset.exe:recset:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
